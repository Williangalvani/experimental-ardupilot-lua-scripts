-- this script echoes NAMED_VALUE_FLOATS so that they can be used in the GCS.
-- This is a workaroung for this issue: https://github.com/mavlink/mavlink2rest/issues/93
